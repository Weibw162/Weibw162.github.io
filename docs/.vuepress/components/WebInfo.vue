  ...
  <div class="web-info card-box">
    ...
    <div class="webinfo-item">
      ...
      <div class="webinfo-content">
        <span class="amount">{{ mdFileCount }}</span> 篇
      </div>
    </div>
    ...
    <div class="webinfo-item">
      ...
      <div class="webinfo-content">
        <span class="amount">{{ createToNowDay }}</span>
        天
      </div>
    </div>
    ...
    <div class="webinfo-item">
      ...
      <div class="webinfo-content">
        <span class="amount">{{ totalWords }}</span> 字
      </div>
    </div>
    ...
    <div class="webinfo-item">
      ...
      <div class="webinfo-content">
        <span class="amount">{{ lastActiveDate }}</span> 前
      </div>
    </div>
