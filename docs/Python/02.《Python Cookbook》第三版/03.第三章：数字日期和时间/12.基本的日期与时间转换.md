---
title: 基本的日期与时间转换
date: 2022-01-06 09:43:12
permalink: /pages/0cf7e1/
categories:
  - Python
  - 《Python Cookbook》第三版
tags:
...
对大多数基本的日期和时间处理问题， `datetime` 模块已经足够了。 如果你需要执行更加复杂的日期操作，比如处理时区，模糊时间范围，节假日计算等等， 可以考虑使用 [dateutil模块](http://pypi.python.org/pypi/python-dateutil)
