---
title: 看完这篇 Session、Cookie、Token，和面试官扯皮就没问题了
date: 2022-01-20 08:24:56
permalink: /pages/e444e7/
categories:
  - 更多
  - 优秀博客文章
tags:
...
本文章摘自掘进，作者：程序员cxuan，原文地址：[https://juejin.cn/post/6844904115080790023](https://juejin.cn/post/6844904115080790023)

:::

![image](https://cdn.jsdelivr.net/gh/Weibw162/image-hosting@dev/image.5xk32ys5yug0.webp)
...
![image](https://cdn.jsdelivr.net/gh/Weibw162/image-hosting@dev/image.63r0aj7710w0.webp)
...
![image](https://cdn.jsdelivr.net/gh/Weibw162/image-hosting@dev/image.17siu977hkcg.webp)

此标头告诉客户端存储 Cookie

现在，随着对服务器的每个新请求，浏览器将使用 Cookie 头将所有以前存储的 Cookie 发送回服务器。

![image](https://cdn.jsdelivr.net/gh/Weibw162/image-hosting@dev/image.2chv4ldsyvi8.webp)
...
![image](https://cdn.jsdelivr.net/gh/Weibw162/image-hosting@dev/image.4pmghzhybok0.webp)
...
![image](https://cdn.jsdelivr.net/gh/Weibw162/image-hosting@dev/image.5rap95y8xgw0.webp)
...
![image](https://cdn.jsdelivr.net/gh/Weibw162/image-hosting@dev/image.4pgnd18nphc0.webp)
...
![image](https://cdn.jsdelivr.net/gh/Weibw162/image-hosting@dev/image.2jkvwt4iv5u0.webp)
...
- 如果想要继续使用 session，需要采用 `URL 重写` 的方式来实现，可以参考 [www.cnblogs.com/Renyi-Fan/p…](https://link.juejin.cn?target=https%3A%2F%2Fwww.cnblogs.com%2FRenyi-Fan%2Fp%2F11012086.html)
